...
export const lodhaHangingGardensSiteConfig = {
  ...
  legal: {
    ...
    legalInfo: [
      ...
      },
      {
        title: "Site Address",
        description:
          "Lodha Hanging Gardens: Taloja By Pass Road, Palava City, Dombivli, Maharashtra 421204",
      },
    ],
    disclaimer:
  ...
  seo: {
    ...
    description:
      "Experience luxury living at Lodha Hanging Gardens, 2 & 3 BHK apartments with world-class amenities.",
